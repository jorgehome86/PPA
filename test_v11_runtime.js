...
for(const f of ['data.js','source_grounded.js','app.js'])vm.runInContext(fs.readFileSync('/mnt/data/v11work/'+f,'utf8'),context);
...
if(results.sourceQ!==40||results.met1Source!==20||results.nav10Source!==20||!results.noChapter0||results.mem50!==50||results.val50!==50||results.pass47||!results.pass48||results.schema!==11||!results.plannerDistinct||results.diag.some(x=>!x[1]))process.exit(1);
